-- File SQL cho hosting (không tạo database mới)
-- HƯỚNG DẪN: 
-- 1. Thay "TEN_DATABASE_CUA_BAN" bằng tên database thật của bạn
-- 2. Hoặc chọn database bên trái phpMyAdmin rồi xóa dòng USE

USE TEN_DATABASE_CUA_BAN;  -- Thay thế tên database ở đây
